 ...
 */
public class CommanderCommandSender implements CommandSender {
	...
	@Override public void setOp(boolean value) {
		throw new UnsupportedOperationException(_("cmdConsoleRankChangeError", ""));
	}

	@Override public void sendMessage(String message) {
	//	CommanderPlugin.Log.info("[Commander Op] "+message);
	}

	@Override public void sendMessage(String[] arg0) {
	//	for (String s : arg0){
	//		CommanderPlugin.Log.info("[Commander Op] "+s);
	//	}
	}
